    ...
    >
      <ConstrainedBox classNames="px-4 py-8 pt-16 z-20 items-center justify-center">
        <Column classNames="w-full items-center justify-center">
          ...
          <p className="text-sm/normal md:text-base/normal dark:text-[var(--textColorLight)] text-center text-[var(--textColorLight)]">
          We specialize in Web Development, Graphics Design, and Mobile App Development.
          </p>
        ...
        <div className="mt-12 lg:mt-16 w-full flex flex-col items-center">
          <p className="text-base/6 font-medium">Follow us @</p>
