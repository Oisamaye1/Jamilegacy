...
export const metadata: Metadata = {
  title: "Jamilegacy",
  description:
    "Jamilegacy is an online service agency that specialize in Web Development, Graphics Design, and Mobile App Development.",
  robots: {
    index: true,
    follow: true,
    googleBot: {
  ...
  keywords: [
    ...
    "Legacy",
    "Jami_legacy",
    "Jami legacy web service",
    "Jamilegacy graphics",
    "Web service",
    "full stack developer",
    "jamilegacy web developer",
  ],
};
